      ...
      <div className="flex items-center space-x-8">
        ...
        >
          <img
            src={uberEatsLogo}
            alt="Uber Eats"
            onClick={() => gtag_report_conversion("https://www.ubereats.com/ca/store/royal-shawarma-3615-dixie-rd/yqiKhlh7XP-uP7qBoXHLHw?diningMode=DELIVERY&pl=%3D&sc=SEARCH_SUGGESTION")}
            className="w-20 h-20 cursor-pointer rounded-lg shadow-xl hover:shadow-2xl transition-shadow"
